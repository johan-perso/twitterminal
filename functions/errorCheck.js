...
module.exports = async function(json){
	...
	if(json.errors && json.errors[0]){
		...
		var returned = {
			...
			.replace("The Twitter REST API v1 is no longer active. Please migrate to API v1.1","La v1.0 de l'API Twitter n'est plus active. Veuillez signaler ce problème.").replace("You can’t mute yourself.","Vous ne pouvez pas masquer votre compte.")
